...
import gas_tft.data_formatters.gas_production
...
class ExperimentConfig(object):
    ...
    default_experiments = ['gas_production']

    def __init__(self, experiment='gas_production', root_folder=None):
    ...
    def data_csv_path(self):
        csv_map = {
            'gas_production': 'GasProductionTFT.csv'
        }
    ...
    def make_data_formatter(self):
        ...
        data_formatter_class = {
            'gas_production': gas_tft.data_formatters.gas_production.GasProductionFormatter
        }
