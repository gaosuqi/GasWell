...
if __name__ == '__main__':
    ...
    # df_tmp['ElapsedProduction'] = pd.Series(
    #     [df_well['ElapsedProduction'].iloc[-1] + i for i in range(1, l_horizon + 1)])
    # df_tmp['Daily_h'] = 24.0
    ...
    # df_result.iloc[-l_horizon:, :] = forecast
